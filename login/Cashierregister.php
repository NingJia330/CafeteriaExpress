...
require_once("../private/CashierloginHelpers.php");
...
$myerr;	
	...
	if(isset($_POST['submit'])){
		...
		if(!isset($myerr) && createAccount($form_userid, $form_password, $form_UserName, $form_email)){
			$status = 1;
			$_SESSION['CashierData']['userid'] = $form_userid;
...
<!-- Viu Logo Header -->	
	<header>
	    ...
	    <h1 class="head"><b>Cafeteria Express Registration</b></h1>
  </header>
<div id="main">
	<div class="signIn">
		<h1 id="regTitle" >Cashier Register here</h1>
		<div id="signInRow">
<form action="Cashierregister.php" method="POST">
	<label for="user"><span class="asterisk">*</span> Employee ID: </label>
	<input class="registerInp" type="text" id="user" name="user" required="required" placeholder="Please enter your employee ID"\></br>
