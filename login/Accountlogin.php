...
require_once("../private/AccountloginHelpers.php");

if(isset($_SESSION['url'])) 
   $url = $_SESSION['url']; // holds url for last page visited.
else 
   $url = "../customer/index.php"; // default page for 
...
<!-- Viu Logo Header -->	
	<header>
	    ...
	    <h1 class="head"><b>VIU Cafeteria Express Login</b></h1>
...
<?php 
	...
	if($status === 1 || $status ===2){
		...
		header("Location: $url");
		echo "<a class=\"logout\" href=\"Accountlogout.php\">Logout</a>";
	}else{
		echo "<a class=\"register\" href=\"Accountregister.php\">Register</a>";
	}
?>
